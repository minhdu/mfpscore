...
//
//	public void Shake () {
//		LTDescr shakeTween = LeanTween.moveLocal(gameObject, Vector3.right, shakeAmt, shakePeriodTime)
...
//		LeanTween.moveLocal(gameObject, Vector3.right, amount, preiodTime)
//			.setEase(LeanTweenType.easeShake) // this is a special ease that is good for shaking
//			.setLoopPingPong()
//			.setRepeat(-1);
//	}
